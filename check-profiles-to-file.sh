#!/bin/bash
# Script para verificar a estrutura da tabela 'professional_profiles' e salvar em arquivo

OUTPUT_FILE="profiles-check-result.txt"

echo "🔍 Verificando estrutura da tabela 'professional_profiles'..." | tee "$OUTPUT_FILE"
...
echo "\n🧪 Obtendo informações da tabela 'professional_profiles'..." | tee -a "$OUTPUT_FILE"
